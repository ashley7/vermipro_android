...
public class CategoryActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        postResponseAsyncTask = new PostResponseAsyncTask(CategoryActivity.this, hashMap,false,
                new AsyncResponse() {
                    @Override
                    public void processFinish(String s) {
                        ...
                        try {
                            ...
                            fundupter = new FunDapter<>(CategoryActivity
    ...
    private void loadProducts(String category_id, final GridView gridView){
        ...
        PostResponseAsyncTask postResponseAsyncTask = new PostResponseAsyncTask(CategoryActivity.this, hashMap,false,
                new AsyncResponse() {
                    @Override
                    public void processFinish(String s) {
